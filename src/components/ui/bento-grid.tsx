...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles for our dark theme
      "bg-gray-900 border border-gray-700 [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      "transform-gpu",
      className,
    )}
  >
    ...
    >
      <Button variant="ghost" asChild size="sm" className="pointer-events-auto text-white hover:bg-white/10">
        <a href={href}>
          {cta}
